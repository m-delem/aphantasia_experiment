  ...
  function startExperiment() {
    ...
    if (fullscreen) {
      ...
      if (keyboardNotAllowed) {
        ...
        DOM_target.append("<div class = jspsych-instructions-nav><p>L'expérience passera en plein écran lorsque vous appuierez sur le bouton ci - dessous.</p><button id='jspsych-fullscreen-btn' class='jspsych-btn'>Lancer l'expérience</button></div>");
